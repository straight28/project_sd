	...
	<table>
		<tr>
			...
			<td><input type="text" name="userid" class="form-control"
				...
				style="color: #271b65; font-size: 15px" onclick="#"> 중복검사 </span> 
		...
		<tr>
			...
			<td><input type="password" name="reuserpass"
				class="form-control" placeholder="비밀번호  확인" required> * 필수
				입력</td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="nickname" class="form-control"
				...
				<span class="btn btn-default glyphicon glyphicon-ok-sign"
				style="color: #271b65; font-size: 15px" onclick="#"> 중복검사 </span> <%-- db에서 닉네임 찾아서 일치여부 검사, 유저id와 동일가능 --%>
			</td>
		</tr>
		...
		<tr>
			...
			<td><input type="email" name="email" class="form-control"
				placeholder="email" required> * 필수 입력 
		</tr>
