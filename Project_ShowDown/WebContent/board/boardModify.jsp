    ...
    <table class="table table-striped">
        ...
        <div class="col-sm-12">
			...
			<input type="hidden" name="command" value="board_update">
                ...
                <tr>
                    <th>제목</th>
                    <td><input type="text" name="boardtitle" class="form-control" value="${oneboard.boardtitle }" disabled="disabled"/></td>
                </tr>
                <tr>
                    <th>내용</th>
                ...
                <tr>
                    ...
                    <td><input type="submit" class="btn btn-default pull-right" value="수정" > </td>
                </tr>
                </tbody>
